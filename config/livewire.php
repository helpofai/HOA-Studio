...
return [
    ...
    */
    ...
    /*
    |---------------------------------------------------------------------------
    | Sub-Directory & Asset URL Support
    |---------------------------------------------------------------------------
    |
    | Allows HOA Studio to run under subdirectories (e.g. helpofai.com/studio)
    | seamlessly across Apache, Nginx, LiteSpeed, and cPanel environments.
    |
    */
