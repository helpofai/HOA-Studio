        ...
        <div class="p-3 rounded-2xl bg-slate-900/90 border border-white/10 shadow-inner space-y-2 font-mono">
            <div class="flex items-center justify-between text-[11px] font-bold text-white">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button type="button" @click="$root.showFloatingTelemetry = !$root.showFloatingTelemetry" class="text-indigo-400 hover:text-white p-1 rounded hover:bg-white/10 transition-colors" title="Pop out Telemetry Monitor" aria-label="Pop out Telemetry Monitor">
