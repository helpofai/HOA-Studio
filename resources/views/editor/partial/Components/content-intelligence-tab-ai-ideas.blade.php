        <!-- â”€â”€â”€ TAB 3: AI CONTENT GAPS, FAQS, E-E-A-T & TABLES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
        <div x-show="rightTab === 'ai_ideas'" class="space-y-3.5" style="display: none;">
            ...
            <div class="space-y-2.5 p-3.5 rounded-2xl bg-slate-900/90 border border-white/10 shadow-inner">
                <div class="flex items-center justify-between">
                    <span class="text-xs font-bold text-white flex items-center gap-1.5">
                        <span class="text-cyan-400">ðŸŽ¯</span>
                    ...
                    >
                        <span wire:loading.remove wire:target="generateContentGaps">âš¡ Find Gaps</span>
            ...
            <div class="space-y-2.5 p-3.5 rounded-2xl bg-slate-900/90 border border-white/10 shadow-inner">
                <div class="flex items-center justify-between">
                    ...
                    >
                        <span wire:loading.remove wire:target="generateFaqSuggestions">âš¡ Generate FAQs</span>
            ...
            <div class="space-y-2.5 p-3.5 rounded-2xl bg-slate-900/90 border border-white/10 shadow-inner">
                <div class="flex items-center justify-between">
                    ...
                    >
                        <span wire:loading.remove wire:target="generateQuickAnswer">âš¡ Generate</span>
            ...
            <div class="space-y-2.5 p-3.5 rounded-2xl bg-slate-900/90 border border-white/10 shadow-inner">
                <div class="flex items-center justify-between">
                    <span class="text-xs font-bold text-white flex items-center gap-1.5">
                        <span class="text-emerald-400">ðŸ›¡ï¸</span>
