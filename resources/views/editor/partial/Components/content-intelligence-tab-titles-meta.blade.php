        ...
        <div x-show="rightTab === 'titles_meta'" class="space-y-3.5" style="display: none;">
            ...
            <div class="space-y-2.5 p-3.5 rounded-2xl bg-slate-900/90 border border-white/10 shadow-inner">
                ...
                <div class="space-y-1">
                    ...
                    <div class="flex items-center gap-1.5">
                        ...
                        <button type="button" wire:click="applyTitle(title)" wire:loading.attr="disabled" class="px-4 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 shadow-md shadow-emerald-600/30 text-white font-bold text-xs flex items-center justify-center gap-2 transition-all">

                            <span class="dual w-3 h-3 border-2" wire:loading wire:target="applyTitle"></span>
            ...
            <div class="space-y-2.5 p-3.5 rounded-2xl bg-slate-900/90 border border-white/10 shadow-inner">
                ...
                <div class="space-y-1">
                    ...
                    <button type="button" wire:click="applyMetaDescription(metaDescription)" wire:loading.attr="disabled" class="px-4 py-1.5 bg-emerald-600 hover:bg-emerald-500 shadow-md shadow-emerald-600/30 text-white rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all">
