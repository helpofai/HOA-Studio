...
<div 
    ...
    :style="`left: ${telemetryX}px; top: ${telemetryY}px; width: ${telemetryW}px; height: ${telemetryH}px;`"
    @mousemove.window="doMoveTelemetry"
    @mouseup.window="endMoveTelemetry"
    @touchmove.window="doMoveTelemetry"
