...
<div
    x-data="{
        show: @js($show),
        focusables() {
            let selector = 'a, button, input:not([type=\x27hidden\x27]), textarea, select, details, [tabindex]:not([tabindex=\x27-1\x27])'
...
>
    ...
    <div
        x-show="show"
        class="mb-6 glass-elevated rounded-2xl overflow-hidden shadow-2xl transform transition-all sm:w-full {{ $maxWidthClass }} sm:mx-auto border border-white/15 z-10"
        x-transition:enter="ease-out duration-300"
