                    ...
                    <div class="relative" x-data="{ userMenuOpen: false }" @click.outside="userMenuOpen = false" @keydown.escape.window="userMenuOpen = false">
                        ...
                        >
                            ...
                            <div class="py-1.5 border-b border-white/10 text-xs">
                                ...
                                <a href="{{ route('documents.index') }}" wire:navigate @click="userMenuOpen = false" class="flex items-center gap-2.5 px-3 py-2 text-slate-300 hover:text-white hover:bg-white/10 transition-colors">
                                ...
                                <a href="{{ route('templates.index') }}" wire:navigate @click="userMenuOpen = false" class="flex items-center gap-2.5 px-3 py-2 text-slate-300 hover:text-white hover:bg-white/10 transition-colors">
                            ...
                            <div class="py-1.5 border-b border-white/10 text-xs">
                                ...
                                @if(auth()->user()?->isAdmin())
                                    <a href="{{ route('admin.dashboard') }}" wire:navigate @click="userMenuOpen = false" class="flex items-center gap-2.5 px-3 py-2 text-violet-300 hover:text-white hover:bg-violet-600/20 transition-colors">
                                        <span class="text-sm">🛡️</span>
                                        <span>Admin Control Center</span>
                                    </a>
                                @endif

                                <a href="{{ route('settings') }}" wire:navigate @click="userMenuOpen = false" class="flex items-center gap-2.5 px-3 py-2 text-slate-300 hover:text-white hover:bg-white/10 transition-colors">
                                    <span class="text-sm">⚙️</span>
