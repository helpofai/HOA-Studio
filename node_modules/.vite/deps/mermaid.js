...
import { $ as purify, C as getDiagramLoader, E as getSiteConfig, I as reset, L as sanitizeCss, N as registerDiagram, P as registerLazyLoadedDiagrams, Q as updateSiteConfig, S as getDiagram, T as getEffectiveHtmlLabels, V as saveConfigFromInitialize, W as setConfig, X as styles_default, Z as themes_default, _ as frontMatterRegex, b as getConfig, c as configureSvgSize, g as evaluate, l as cssStyleSheetToString, m as detectors, n as addDirective, p as detectType, q as setSiteConfig, r as assignWithDepth_default, t as UnknownDiagramError, u as defaultConfig } from "./chunk-DU6HZSFF-Bvw2Lp9r.js";
import { S as isBuffer, a as decodeEntities, f as isDetailedError, g as utils_default, h as removeDirectives, i as cleanAndMerge, o as encodeEntities, v as isTypedArray, x as isArrayLike, y as isArguments } from "./chunk-75Z2AOVW-Cp5XZCt1.js";
import { t as selectSvgElement } from "./chunk-CLGD4ZFX-DTD8ZnKU.js";
import "./chunk-P2QGCYS3-BT0blOip.js";
import { r as registerIconPacks } from "./chunk-PWAF6VOD-Cx-cMRWr.js";
import { i as dedent } from "./chunk-GMAD6QVW-CxL8kvir.js";
import "./chunk-4HAMMTFA-VinmuPSs.js";
import "./chunk-GVQU2GXP-DcbX62bW.js";
import "./chunk-L3NEJ4N5-CMr-QeKo.js";
import "./chunk-OSK3NFVY-CW1YHLTS.js";
import { i as createCommonLayoutRenderer, l as paintLayoutData, n as clearLayoutRenderState, o as defaultMeasureLayout } from "./chunk-2E4U76K2-D298tNHQ.js";
import { n as load, t as JSON_SCHEMA } from "./chunk-LNGE3PJU-Imzk1uLQ.js";
import { n as registerLayoutLoaders } from "./chunk-TLUHSLCS-279qvRrf.js";
...
var c4Detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./c4Diagram-7LVT6UL2-7FLZ9Wd-.js");
		return {
			id,
			diagram: diagram2
		};
...
var flowDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./flowDiagram-HODETNUW-B6Ai8NuP.js");
		return {
			id: id2,
			diagram: diagram2
		};
...
var detector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./swimlanesDiagram-VR7AAH4N-CzwzLhc3.js");
		return {
			id: id4,
			diagram: diagram2
		};
...
var erDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./erDiagram-RLTQ6QDP-CClaFbyQ.js");
		return {
			id: id5,
			diagram: diagram2
		};
...
var gitGraphDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./gitGraphDiagram-WWUBYQGX-DNIcRoO1.js");
		return {
			id: id6,
			diagram: diagram2
		};
...
var ganttDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ganttDiagram-EL5Y4UJY-CTJiMALN.js");
		return {
			id: id7,
			diagram: diagram2
		};
...
var info = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./infoDiagram-27XIBGKW-BCiTk3la.js");
		return {
			id: id8,
			diagram: diagram2
		};
...
var pie = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pieDiagram-E7YTZNPT-FrYascQW.js");
		return {
			id: id9,
			diagram: diagram2
		};
...
var quadrantDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./quadrantDiagram-AXDQQJYC-CI20tGpR.js");
		return {
			id: id10,
			diagram: diagram2
		};
...
var xychartDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./xychartDiagram-S5SC5T6Z-XfYytIUp.js");
		return {
			id: id11,
			diagram: diagram2
		};
...
var requirementDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./requirementDiagram-BXWQKSXE-W2xRqSvf.js");
		return {
			id: id12,
			diagram: diagram2
		};
...
var sequenceDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sequenceDiagram-WJ2MYXX4-Djm3f6E2.js");
		return {
			id: id13,
			diagram: diagram2
		};
...
var classDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-ZZMXUADV-An4H8Coy.js");
		return {
			id: id14,
			diagram: diagram2
		};
...
var classDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./classDiagram-v2-VYDZK3BY-CmEthm0Z.js");
		return {
			id: id15,
			diagram: diagram2
		};
...
var stateDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-D77RDMKH-uj5tqeYO.js");
		return {
			id: id16,
			diagram: diagram2
		};
...
var stateDetector_V2_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./stateDiagram-v2-MP3YSRHH-GhgwHIKV.js");
		return {
			id: id17,
			diagram: diagram2
		};
...
var journeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./journeyDiagram-3NMN7TZE-CcubKlHf.js");
		return {
			id: id18,
			diagram: diagram2
		};
...
var detector_default3 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./timeline-definition-24CTP7MA-CbMRjG_T.js");
		return {
			id: id20,
			diagram: diagram2
		};
...
var detector_default4 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./mindmap-definition-YA3MSWOX-DaHoF9zr.js");
		return {
			id: id21,
			diagram: diagram2
		};
...
var detector_default5 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./kanban-definition-UXKFOSKX-CheVQBIB.js");
		return {
			id: id22,
			diagram: diagram2
		};
...
var sankeyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./sankeyDiagram-P5KCCOFB-mcEu8Twm.js");
		return {
			id: id23,
			diagram: diagram2
		};
...
var packet = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-Z3DM3KII-DUWlYnd7.js");
		return {
			id: id24,
			diagram: diagram2
		};
...
var radar = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-UQ7AKVKN-nlrS5pdA.js");
		return {
			id: id25,
			diagram: diagram2
		};
...
var blockDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./blockDiagram-I7D4REHJ-0l51eNbr.js");
		return {
			id: id26,
			diagram: diagram2
		};
...
var detector_default6 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-S7CK7UJ4-CJsQPgSA.js");
		return {
			id: id27,
			diagram: diagram2
		};
...
var architectureDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./architectureDiagram-5GKGNRK7-Ok2TFTWv.js");
		return {
			id: id28,
			diagram: diagram2
		};
...
var detector_default7 = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-VSXAHHWV-BeSGctpT.js");
		return {
			id: id29,
			diagram: diagram2
		};
...
var ishikawa = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ishikawaDiagram-5VMMS53U-BzS7WVtt.js");
		return {
			id: id30,
			diagram: diagram2
		};
...
var vennDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./vennDiagram-4TSXK5OY-BGgpHxRG.js");
		return {
			id: id31,
			diagram: diagram2
		};
...
var treemap = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./diagram-VX7I27RA-jus2IMpG.js");
		return {
			id: id32,
			diagram: diagram2
		};
...
var wardleyDetector_default = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./wardleyDiagram-VM6X3IG4-CHFEC7CA.js");
		return {
			id: id33,
			diagram: diagram2
		};
...
var cynefin = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./cynefinDiagram-5FMLGOSQ-CXZwneqQ.js");
		return {
			id: id34,
			diagram: diagram2
		};
...
var railroad = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./railroadDiagram-O6MQD6OU-BFm5wiLB.js");
		return {
			id: id35,
			diagram: diagram2
		};
...
var railroadEbnf = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./ebnfDiagram-PWID7BFC-BSSRKNwK.js");
		return {
			id: id36,
			diagram: diagram2
		};
...
var railroadAbnf = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./abnfDiagram-VCTEODGH-0WZ78Ppq.js");
		return {
			id: id37,
			diagram: diagram2
		};
...
var railroadPeg = {
	...
	loader: /* @__PURE__ */ __name(async () => {
		const { diagram: diagram2 } = await import("./pegDiagram-XKGWAZYB-bV_VYKts.js");
		return {
			id: id38,
			diagram: diagram2
		};
